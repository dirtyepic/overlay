...
src_install() {
	...
	bashcomp_alias emerge {e,vieb,vich,cdeb,ebmd,detest,ebclean,ebmanifest,ebfmanifest,ebsetup,ebcsetup,ebunpack,ebcunpack,ebprepare,ebcprepare,ebconfigure,ebcconfigure,ebcompile,ebccompile,ebtest,ebctest,ebinstall,ebcinstall,ebmerge,ebcmerge,em,cp2overlay,ekwshow,eshowkw}
}
